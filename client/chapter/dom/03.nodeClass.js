...
console.log(about.nodeType === document.ELEMENT_NODE); //true
console.log(about.nodeName === 'DIV'); //true
console.log(about.tagName === 'DIV'); //true
...
// 그래서 대체재로 textContent 사용
// - textContent
// * 요소 내의 텍스트에 접근
// * 태그는 제외하고 오로지 텍스트만 추출

first.textContent = '<h1>Bye</h1>'
...
//고성능 애니메이션을 위한 JavaScript 라이브러리
